...
ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_USE_RMM),y)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += rmm 
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	ENABLE_RME=1 \
  RMM=$(BINARIES_DIR)/rmm.img
endif
...
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += trustleech
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += TRUSTLEECH=$(BINARIES_DIR)/trustleech.bin
