...
static void aarch64_cpu_dump_state(CPUState *cs, FILE *f, int flags)
{
    ...
    // System registers for VMI 
    qemu_fprintf(f, " TCR_EL1=%016" PRIx64 " ", env->cp15.tcr_el[1]);
    qemu_fprintf(f, " TTBR0_EL1=%016" PRIx64 " ", env->cp15.ttbr0_ns);
    qemu_fprintf(f, " TTBR1_EL1=%016" PRIx64 " ", env->cp15.ttbr1_ns);
    qemu_fprintf(f, " SCTLR_EL1=%016" PRIx64 " ", env->cp15.sctlr_ns);
}
