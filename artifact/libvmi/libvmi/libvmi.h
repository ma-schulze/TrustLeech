...
#define ENABLE_TRUSTLEECH // TRUSTLEECH MASSIVE TODO
...
typedef enum vmi_mode {
  ...
  VMI_TRUSTLEECH /** < libvmi is monitoring a TrustLeech VM */
} vmi_mode_t;
...
// TODO, integrate?
typedef struct aarch64_registers {
  uint64_t gpregs_ctx[32];
  uint64_t vttbr_el2;
  uint64_t vsttbr_el2;
  uint64_t vtcr_el2;
  uint64_t vstcr_el2;
  ...
  uint64_t mdscr_el1;
  uint64_t spsr_el12;
  uint64_t cntv_cval_el02;
  uint64_t cntv_ctl_el02;
  uint64_t cntp_cval_el02;
  uint64_t cntp_ctl_el02;
  uint64_t scxtnum_el12;
  uint64_t tfsr_el12;
  ...
  uint64_t ich_ap0r1_el2;
  uint64_t ich_ap0r2_el2;
  uint64_t ich_ap0r3_el2;
  uint64_t ich_ap1r0_el2;
  uint64_t ich_ap1r1_el2;
  uint64_t ich_ap1r2_el2;
  uint64_t ich_ap1r3_el2;
  ...
  uint64_t amevcntvoff00_el2;
  uint64_t amevcntvoff01_el2;
  uint64_t amevcntvoff02_el2;
  uint64_t amevcntvoff03_el2;
  uint64_t amevcntvoff04_el2;
  uint64_t amevcntvoff05_el2;
  uint64_t amevcntvoff06_el2;
  uint64_t amevcntvoff07_el2;
  uint64_t amevcntvoff08_el2;
  uint64_t amevcntvoff09_el2;
  uint64_t amevcntvoff010_el2;
  uint64_t amevcntvoff011_el2;
  uint64_t amevcntvoff012_el2;
  uint64_t amevcntvoff013_el2;
  uint64_t amevcntvoff014_el2;
  uint64_t amevcntvoff015_el2;
  uint64_t amevcntvoff10_el2;
  uint64_t amevcntvoff11_el2;
  uint64_t amevcntvoff12_el2;
  uint64_t amevcntvoff13_el2;
  uint64_t amevcntvoff14_el2;
  uint64_t amevcntvoff15_el2;
  uint64_t amevcntvoff16_el2;
  uint64_t amevcntvoff17_el2;
  uint64_t amevcntvoff18_el2;
  uint64_t amevcntvoff19_el2;
  uint64_t amevcntvoff110_el2;
  uint64_t amevcntvoff111_el2;
  uint64_t amevcntvoff112_el2;
  uint64_t amevcntvoff113_el2;
  uint64_t amevcntvoff114_el2;
  uint64_t amevcntvoff115_el2;

  // Add previously defined debug register variables here
