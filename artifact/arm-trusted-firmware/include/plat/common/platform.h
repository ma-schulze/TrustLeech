...
struct trustleech_context_stash;
struct image_desc;
struct bl_load_info;
struct bl_params;
struct mmap_region;
...
/*******************************************************************************
 * TrustLeech functions
 *******************************************************************************/

const struct entry_point_info *bl31_plat_get_trustleech_ep_info(void);
void bl31_plat_get_trustleech_context_stash(struct trustleech_context_stash **out_area, size_t *out_num_elements);
