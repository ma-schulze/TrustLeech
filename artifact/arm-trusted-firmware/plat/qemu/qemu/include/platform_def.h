...
#define TRUSTLEECH_IRQ_CFG
#ifdef TRUSTLEECH_IRQ_CFG
#define DESC_G0_IRQ_SEC_SGI(grp)					\
	INTR_PROP_DESC(QEMU_IRQ_SEC_SGI_0, 0x20, (grp), \
					   GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(29, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL)
...
#define PLAT_TL_PRI        0x20

#define PLAT_EHF_DESC EHF_PRI_DESC(QEMU_PRI_BITS, PLAT_TL_PRI), \
			EHF_PRI_DESC(QEMU_PRI_BITS, 0x30)
