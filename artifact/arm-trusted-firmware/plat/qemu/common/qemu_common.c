...
#define MAP_TRUSTLEECH	MAP_REGION_FLAT(TRUSTLEECH_BASE,		\
					TRUSTLEECH_AREA_SIZE,		\
					MT_MEMORY | MT_RW | EL3_PAS)

#define MAP_TRUSTLEECH_CONTEXT	MAP_REGION_FLAT(TRUSTLEECH_CONTEXT_STASH_BASE,	\
						TRUSTLEECH_CONTEXT_STASH_SIZE,	\
					MT_MEMORY | MT_RW | EL3_PAS)
