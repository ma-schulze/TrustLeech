...
#define TRUSTLEECH_IMAGE_NAME		"trustleech.bin"
...
static const io_uuid_spec_t trustleech_uuid_spec = {
	.uuid = UUID_TRUSTLEECH,
};
...
static const struct plat_io_policy policies[] = {
	...
	[TRUSTLEECH_IMAGE_ID] = {
		&fip_dev_handle,
		(uintptr_t)&trustleech_uuid_spec,
		open_fip,
	},
